...
{block name='content'}
        ...
        <section id="main" >
            ...
            <div class="row row_product">
                ...
                <div class="product_center_block {if !{widget name="blockproductinfo"}} width66 {/if}">
                    {block name='page_header_container'}
                        {block name='page_header'}
                            <h1 class="h1 name_prod_page" itemprop="name">{block name='page_title'}{$product.name}{/block}</h1>
                        {/block}
                    {/block}
                    ...
                    <div class="product-information">
                        ...
                        {widget name="mpm_socialsharebuttons" product=$product.id}


                    </div>
                </div>

                <div class="product_right_block" {if !{widget name="blockproductinfo"}} style="display: none" {/if}>

                    {widget name="blockproductinfo"}
        ...
        {if $accessories}
            <section class="product-accessories ">
                <div class="product-accessories-title">
                    ...
                    <div class="arrows_slider_productscategory ">
                        <div class="arrow_prev disabled"></div>
                        <div class="arrow_next"></div>
                    </div>
                </div>

                <div class="products" data-count="{count($accessories)}">
