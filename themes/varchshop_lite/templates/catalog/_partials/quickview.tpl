   ...
   <div class="modal-content">
     ...
     <div class="modal-body">
      <div class="row">
        ...
        <div class="quickview_left_block col-md-6 col-sm-6 hidden-xs-down">
            <div class="quickview_left_block_img">
              {block name='product_cover_tumbnails'}
                {include file='catalog/_partials/product-cover-thumbnails.tpl'}
              {/block}
            </div>

            <div class="quickview_left_block_soc">
              {widget name="mpm_socialsharebuttons" product=$product.id}
            </div>
        </div>


        <div class="quickview_center_block col-md-6 col-sm-6">
        ...
        <div class="quickview_righ_block">
