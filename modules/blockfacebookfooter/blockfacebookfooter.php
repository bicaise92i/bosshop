...
class blockfacebookfooter extends Module implements WidgetInterface
{
	public function __construct()
	{
		$this->name = 'blockfacebookfooter';
    ...
    $this->templateFile = 'module:blockfacebookfooter/views/templates/hook/blockfacebookfooter.tpl';
	}
  ...
  {
    $this->context->controller->registerStylesheet('blockfacebookfooter', 'modules/blockfacebookfooter/views/css/blockfacebookfooter.css',  array('media' => 'all', 'priority' => 900) );
    $this->context->controller->registerJavascript( 'blockfacebookfooter',  'modules/blockfacebookfooter/views/js/blockfacebookfooter.css', array('position' => 'bottom', 'priority' => 100) );
