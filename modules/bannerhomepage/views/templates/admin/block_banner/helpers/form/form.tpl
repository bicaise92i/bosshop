				...
				{/if}
					<div class="col-lg-6">
						{if isset($images[$language.id_lang]['size']) && $images[$language.id_lang]['size']}
							...
							<span class="size">{l s='Size: ' mod='bannerhomepage'}{$images[$language.id_lang]['size']|escape:'htmlall':'UTF-8'}</span>
						{elseif !$images[$language.id_lang]['size'] && $images[$lang_def->id]['size']}
							...
							<span class="size">{l s='Size: ' mod='bannerhomepage'}{$images[$lang_def->id]['size']|escape:'htmlall':'UTF-8'}</span>
						{/if}
						<div class="dummyfile input-group">
							...
							<span class="input-group-btn">
								<button id="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
									<i class="icon-folder-open"></i> {l s='Choose a file' mod='bannerhomepage'}
								</button>
							</span>
						</div>
					</div>
